...
/**
 * HubspotIntegrationModuleAsset AssetBundle
 *
 ...
 * @since     0.0.1
 */
class HubspotIntegrationModuleAsset extends AssetBundle
{
    // Public Methods
    // =========================================================================
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@modules/hubspotintegrationmodule/assetbundles/hubspotintegrationmodule/dist";
        ...
        $this->js = [
            'js/HubspotIntegrationModule.js',
        ];

        $this->css = [
            'css/HubspotIntegrationModule.css',
        ];
